                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-info">
                                    <?php echo number_format($anggota_aktif, 1); ?> aktif
                                </small>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="badge bg-success"><?php $pinjam1; ?>x</span>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-success"><?php $pinjam3; ?>x</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="progress" style="height: 30px;">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $persentase_tersedia; ?>%;" aria-valuenow="<?php echo $persentase_tersedia; ?>" aria-valuemin="0" aria-valuemax="100">
                                        <?php echo number_format($persentase_tersedia, 1); ?>% (<?php echo $buku_tersedia; ?> buku)
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <h6>Buku Dipinjam</h6>
                                <div class="progress" style="height: 30px;">
                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo $persentase_dipinjam; ?>%;" aria-valuenow="<?php echo $persentase_dipinjam; ?>" aria-valuemin="0" aria-valuemax="100">
                                        <?php echo number_format($persentase_dipinjam, 1); ?>% (<?php echo $buku_dipinjam; ?> buku)
                                    </div>
                                </div>
                            </div>
                        </div>
