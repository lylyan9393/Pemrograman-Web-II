            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p><strong>Stok:</strong> Rp <?php echo $stok1; ?> buku</p>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p><strong>Stok:</strong> Rp <?php echo $stok2; ?> buku</p>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p><strong>Stok:</strong> Rp <?php echo $stok3; ?> buku</p>

                        <?php
                        // logika ketersediaan lebih detail
                        if ($stok3 == 0) {
