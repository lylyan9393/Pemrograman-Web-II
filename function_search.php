...
<body>
    <div class="container mt-5">
        ...
        function cari_by_tersedia($buku_list) {
            $hasil = [];
            foreach ($buku_list as $buku) {
                if ($buku["stok"] > 0) {
                    $hasil[] = $buku;
        ...
        function cari_by_terbaru($buku_list, $tahun) {
            $hasil = [];
            foreach ($buku_list as $buku) {
                if ($buku["tahun"] >= $tahun) {
                    $hasil[] = $buku;
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <?php
                $hasil = cari_by_tersedia($buku_list);
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php
                $tahun = 2024;
                $hasil = cari_by_terbaru($buku_list, $tahun);
